...
/*   Updated: 2025/05/21 14:29:24 by frmarian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool is_double_redir(char *str)
{
    if (!str)
        return (false);
    if (ft_strlen(str) == 2 && ((ft_strncmp(str, ">>", 2) == 0 || ft_strncmp(str, "<<", 2) == 0)))
        return (true);
    return (false);
}
...
static bool	is_single_redir(char *str)
{
    if (!str)
        return (false);
    if (ft_strlen(str) == 1 && ((ft_strncmp(str, ">", 1) == 0 || ft_strncmp(str, "<", 1) == 0) || ft_strncmp(str, "|", 1) == 0))
        return (true);
    return (false);
}
